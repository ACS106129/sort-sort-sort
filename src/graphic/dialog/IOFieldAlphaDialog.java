...
public class IOFieldAlphaDialog extends JDialog {
    ...
    public IOFieldAlphaDialog(Frame owner) {
        super(owner, "I/O Field Alpha", ModalityType.APPLICATION_MODAL);
    ...
    private void initButton() {
        ...
        okButton.setOnAction(e -> {
            Setting.IOFieldAlpha = Integer.valueOf(textPane.getText());
            IOFieldAlphaDialog.this.dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
        });
        ...
        defaultButton.setOnAction(e -> {
            scrollBar.setValue(Setting.IOFieldAlphaDefault);
        });
        defaultButton.setStyle("-fx-font: 18 arial; -fx-base: #363535;");
    }

    private void initComps() {
        textPane.setText(String.valueOf(Setting.IOFieldAlpha));
        textPane.setOpaque(false);
        textPane.setEditable(false);
        scrollBar.setMin(0);
        scrollBar.setMax(255);
        scrollBar.setValue(Setting.IOFieldAlpha);
        scrollBar.valueProperty().addListener((observable, oldvalue, newvalue) -> {
            textPane.setText(String.valueOf(newvalue.intValue()));
        });
    }
}